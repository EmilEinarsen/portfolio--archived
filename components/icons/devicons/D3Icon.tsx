...
export const D3Icon = createIcon({
  ...
  viewBox: '0 0 128 128',
	path: [
		...
		<linearGradient key={2} id="d3js-a" gradientUnits="userSpaceOnUse" x1="85.24" y1="97.604" x2="91.053" y2="-49.515">
			<stop offset="0"/>
			<stop offset="1"/>
		</linearGradient>,
		<linearGradient key={3} id="d3js-b" gradientUnits="userSpaceOnUse" x1="33.627" y1="97.714" x2="39.382" y2="-47.925">
			<stop offset="0"/>
			<stop offset="1"/>
		</linearGradient>,
	],
